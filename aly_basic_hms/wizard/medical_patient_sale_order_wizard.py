...
class MedicalPatientSaleOrderWizard(models.TransientModel):
    ...
    def create_invoice(self):
        ...
        for active_id in active_ids:
            ...
            price_list_id = self.env.user.pricelist_id and medical_patient_obj.insurance_company_id.property_product_pricelist.id if medical_patient_obj.is_insurance else medical_patient_obj.partner_id.property_product_pricelist.id or False
