...
class MedicalOperationInvoiceWizard(models.TransientModel):
    _name = "medical.operation.invoice.wizard"

    def create_invoice(self):
        active_ids = self._context.get('active_ids')
        list_of_ids = []
        lab_req_obj = self.env['medical.operation']
        ...
        for active_id in active_ids: 
            ...
            if lab_req.no_invoice == False:
                ...
                invoice_vals = {
                'name': self.env['ir.sequence'].next_by_code('medical_operation_inv_seq'),
                ...
                for p_line in lab_req.operation_line_ids:
