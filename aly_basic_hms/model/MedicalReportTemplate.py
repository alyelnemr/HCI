...
class MedicalReportTemplate(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        min_date = pytz.utc.localize(min_date_str).astimezone(local).strftime("%d/%m/%Y %H:%M:%S") if isinstance(min_date_str, datetime) else datetime.strptime(min_date_str, "%d/%m/%Y %H:%M:%S")
